// Main application
{
    ...
    Graphics.prototype.setFont7Seg = function() {
      return this.setFont("6x8");  // Use standard 6x8 font
    };
    ...
    const initClockInfo = function() {
      setTimeout(() => {
        ...
        clockInfoItems = clockInfo.load();
  
        // Add custom Distance item
        try {
          const distanceItem = require("distance");
